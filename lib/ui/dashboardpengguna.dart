...
import 'package:mobile_kelompok/ui/pesan1.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Dashboardpengguna(),
    );
  }
}

class Dashboardpengguna extends StatelessWidget {
  const Dashboardpengguna({super.key});
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          _buildMenuButton(context, 'Ganti Sparepart'),
                          _buildMenuButton(context, 'Cat dan Oli'),
                        ],
                      ),
                    ),
                  ),
    ...
    return ElevatedButton.icon(
      onPressed: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => Pesan1Screen(fromMenu: label),
          ),
        );
      },
